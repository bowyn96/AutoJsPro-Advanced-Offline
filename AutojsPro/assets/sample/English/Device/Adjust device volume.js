...
ui.layout(
    <vertical padding="16">
        <text textColor="black" textSize="16sp">music volume</text>
        <seekbar id="music"/>

        <text textColor="black" textSize="16sp">notification volume</text>
        <seekbar id="notification"/>

        <text textColor="black" textSize="16sp">alarm volume</text>
        <seekbar id="alarm"/>
    </vertical>
);
