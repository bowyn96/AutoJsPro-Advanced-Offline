...
export declare function registerBroadcastReceiver(filter: string | string[] | android.content.IntentFilter): BroadcastReceiver;
export declare function unregisterBroadcastReceiver(receiver: BroadcastReceiver): void;
