...
.field public static final f:Lj$/time/B;

.field public static final g:Lj$/time/B;

.field public static final h:Lj$/time/B;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/B;->d:Lj$/util/concurrent/ConcurrentHashMap;

    new-instance v0, Lj$/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0, v1, v2, v3}, Lj$/util/concurrent/ConcurrentHashMap;-><init>(IFI)V

    sput-object v0, Lj$/time/B;->e:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    sput-object v0, Lj$/time/B;->f:Lj$/time/B;
    ...
    sput-object v0, Lj$/time/B;->g:Lj$/time/B;
    ...
    sput-object v0, Lj$/time/B;->h:Lj$/time/B;
...
.method private constructor <init>(I)V
    ...
    invoke-direct {p0}, Lj$/time/A;-><init>()V

    iput p1, p0, Lj$/time/B;->b:I
    ...
    .line 2
    :goto_4
    iput-object p1, p0, Lj$/time/B;->c:Ljava/lang/String;

    return-void
.end method

.method public static L(Ljava/lang/String;)Lj$/time/B;
    .locals 7
    ...
    .line 2
    sget-object v0, Lj$/time/B;->e:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p0, v2, v3}, Lj$/time/B;->O(Ljava/lang/CharSequence;IZ)I

    move-result v0

    invoke-static {p0, v6, v2}, Lj$/time/B;->O(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v5, v2}, Lj$/time/B;->O(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v1, v3}, Lj$/time/B;->O(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v4, v3}, Lj$/time/B;->O(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v0, v1}, Lj$/time/B;->M(III)Lj$/time/B;
    ...
    :cond_9
    invoke-static {v0, v1, v2}, Lj$/time/B;->M(III)Lj$/time/B;
...
.method public static M(III)Lj$/time/B;
    .locals 4
...
.method public static N(I)Lj$/time/B;
    .locals 3
    ...
    sget-object v1, Lj$/time/B;->d:Lj$/util/concurrent/ConcurrentHashMap;

    invoke-interface {v1, v0}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lj$/time/B;

    if-nez v2, :cond_0

    new-instance v2, Lj$/time/B;

    invoke-direct {v2, p0}, Lj$/time/B;-><init>(I)V
    ...
    sget-object p0, Lj$/time/B;->e:Lj$/util/concurrent/ConcurrentHashMap;

    .line 1
    iget-object v0, v2, Lj$/time/B;->c:Ljava/lang/String;
    ...
    invoke-direct {v0, p0}, Lj$/time/B;-><init>(I)V
...
.method static P(Ljava/io/DataInput;)Lj$/time/B;
    .locals 2
...
.method public final D()Lj$/time/zone/e;
    ...
    invoke-static {p0}, Lj$/time/zone/e;->i(Lj$/time/B;)Lj$/time/zone/e;
...
.method final I(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {p0, p1}, Lj$/time/B;->Q(Ljava/io/DataOutput;)V

    return-void
.end method

.method public final J(Lj$/time/B;)I
    .locals 1
...
.method public final j()Ljava/lang/String;
    ...
    iget-object v0, p0, Lj$/time/B;->c:Ljava/lang/String;
...
.method public final l(Lj$/time/temporal/p;)I
    ...
    .line 2
    invoke-virtual {p0, p1}, Lj$/time/B;->q(Lj$/time/temporal/p;)J
...
.method public final t(Lj$/time/temporal/x;)Ljava/lang/Object;
    ...
    :cond_0
    invoke-static {p0, p1}, Lj$/time/temporal/o;->d(Lj$/time/temporal/l;Lj$/time/temporal/x;)Ljava/lang/Object;
