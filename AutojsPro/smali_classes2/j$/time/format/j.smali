...
.method public final g(Lj$/time/format/s;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v3, v4}, Lj$/time/temporal/l;->f(Lj$/time/temporal/p;)Z
    ...
    invoke-interface {v2, v4}, Lj$/time/temporal/l;->q(Lj$/time/temporal/p;)J
    ...
    :goto_1
    invoke-virtual {v4, v1, v2}, Lj$/time/temporal/a;->D(J)I
    ...
    invoke-static {v5, v6, v7, v8}, Lj$/time/c;->b(JJ)J

    move-result-wide v5

    sub-long/2addr v5, v13

    sget-object v7, Lj$/time/B;->f:Lj$/time/B;

    invoke-static {v5, v6, v3, v7}, Lj$/time/k;->R(JILj$/time/B;)Lj$/time/k;
    ...
    invoke-virtual {v5}, Lj$/time/k;->K()I
    ...
    sget-object v13, Lj$/time/B;->f:Lj$/time/B;

    invoke-static {v7, v8, v3, v13}, Lj$/time/k;->R(JILj$/time/B;)Lj$/time/k;
    ...
    invoke-virtual {v7}, Lj$/time/k;->K()I
    ...
    invoke-virtual {v7}, Lj$/time/k;->L()I
