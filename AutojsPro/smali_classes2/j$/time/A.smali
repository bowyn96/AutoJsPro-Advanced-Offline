.class public abstract Lj$/time/A;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/A;->a:Ljava/util/Map;
...
.method public static E(Ljava/lang/String;Ljava/util/Map;)Lj$/time/A;
    .locals 1
...
.method static F(Ljava/lang/String;Z)Lj$/time/A;
    .locals 2
    ...
    :goto_0
    invoke-static {p0, v0, p1}, Lj$/time/A;->H(Ljava/lang/String;IZ)Lj$/time/A;
    ...
    :cond_2
    invoke-static {p0, p1}, Lj$/time/C;->J(Ljava/lang/String;Z)Lj$/time/C;
    ...
    :cond_4
    :goto_2
    invoke-static {p0}, Lj$/time/B;->L(Ljava/lang/String;)Lj$/time/B;
...
.method public static G(Ljava/lang/String;Lj$/time/B;)Lj$/time/A;
    .locals 2
    ...
    .line 4
    invoke-direct {v0, p0, p1}, Lj$/time/C;-><init>(Ljava/lang/String;Lj$/time/zone/e;)V

    return-object v0
.end method

.method private static H(Ljava/lang/String;IZ)Lj$/time/A;
    .locals 3
    ...
    sget-object p0, Lj$/time/B;->f:Lj$/time/B;

    invoke-static {v0, p0}, Lj$/time/A;->G(Ljava/lang/String;Lj$/time/B;)Lj$/time/A;
    ...
    invoke-static {p0, p2}, Lj$/time/C;->J(Ljava/lang/String;Z)Lj$/time/C;
    ...
    invoke-static {p1}, Lj$/time/B;->L(Ljava/lang/String;)Lj$/time/B;

    move-result-object p1

    sget-object p2, Lj$/time/B;->f:Lj$/time/B;

    if-ne p1, p2, :cond_2

    invoke-static {v0, p1}, Lj$/time/A;->G(Ljava/lang/String;Lj$/time/B;)Lj$/time/A;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lj$/time/A;->j()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1}, Lj$/time/A;->j()Ljava/lang/String;
