...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;,
        Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;
    }
.end annotation
...
.field private final reflectionAccessors:Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;
...
.method public constructor <init>(Landroid/view/View;I)V
    ...
    new-instance v0, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;

    invoke-direct {v0}, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;-><init>()V

    iput-object v0, p0, Lio/flutter/view/AccessibilityViewEmbedder;->reflectionAccessors:Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;
...
.method private addChildrenToFlutterNode(Landroid/view/accessibility/AccessibilityNodeInfo;Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iget-object v2, p0, Lio/flutter/view/AccessibilityViewEmbedder;->reflectionAccessors:Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;

    .line 1
    iget-object v3, v2, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->Ԫ:Ljava/lang/reflect/Method;

    const/4 v4, 0x0

    if-nez v3, :cond_0

    iget-object v5, v2, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->ԫ:Ljava/lang/reflect/Field;

    if-eqz v5, :cond_2

    iget-object v5, v2, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->Ԭ:Ljava/lang/reflect/Method;
    ...
    :cond_1
    :try_start_1
    iget-object v3, v2, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->Ԭ:Ljava/lang/reflect/Method;

    iget-object v2, v2, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->ԫ:Ljava/lang/reflect/Field;
    ...
    new-instance v2, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;

    invoke-direct {v2, p2, v3}, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;-><init>(Landroid/view/View;I)V
    ...
    invoke-direct {p0, p2, v3, v2}, Lio/flutter/view/AccessibilityViewEmbedder;->cacheVirtualIdMappings(Landroid/view/View;II)V
...
.method private cacheVirtualIdMappings(Landroid/view/View;II)V
    ...
    new-instance v0, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;

    invoke-direct {v0, p1, p2}, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;-><init>(Landroid/view/View;I)V
...
.method private setFlutterNodeParent(Landroid/view/accessibility/AccessibilityNodeInfo;Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iget-object v0, p0, Lio/flutter/view/AccessibilityViewEmbedder;->reflectionAccessors:Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;

    .line 1
    iget-object v0, v0, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->Ԩ:Ljava/lang/reflect/Method;
    ...
    invoke-static {v4, v5, v1}, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->Ԩ(JI)Z
    ...
    invoke-static {v4, v5, p1}, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->Ԩ(JI)Z
    ...
    new-instance v1, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;

    invoke-direct {v1, p2, p1}, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;-><init>(Landroid/view/View;I)V
...
.method public createAccessibilityNodeInfo(I)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    check-cast v0, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;
    ...
    iget-object v3, v0, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;->Ϳ:Landroid/view/View;
    ...
    :cond_1
    iget-object v2, v0, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;->Ϳ:Landroid/view/View;
    ...
    iget v3, v0, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;->Ԩ:I
    ...
    :cond_3
    iget-object v0, v0, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;->Ϳ:Landroid/view/View;
...
.method public getRecordFlutterId(Landroid/view/View;Landroid/view/accessibility/AccessibilityRecord;)Ljava/lang/Integer;
    ...
    invoke-static {v0, p2}, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->Ϳ(Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;Landroid/view/accessibility/AccessibilityRecord;)Ljava/lang/Long;
    ...
    invoke-direct {v1, p1, p2}, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;-><init>(Landroid/view/View;I)V
...
.method public getRootNode(Landroid/view/View;ILandroid/graphics/Rect;)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    iget-object v1, p0, Lio/flutter/view/AccessibilityViewEmbedder;->reflectionAccessors:Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;

    .line 1
    iget-object v1, v1, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->Ϳ:Ljava/lang/reflect/Method;
...
.method public onAccessibilityHoverEvent(ILandroid/view/MotionEvent;)Z
    ...
    check-cast v2, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;
    ...
    iget-object v5, v2, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;->Ϳ:Landroid/view/View;
    ...
    iget-object v2, v2, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;->Ϳ:Landroid/view/View;
...
.method public performAction(IILandroid/os/Bundle;)Z
    ...
    check-cast p1, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;
    ...
    :cond_0
    iget-object v1, p1, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;->Ϳ:Landroid/view/View;
    ...
    :cond_1
    iget p1, p1, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;->Ԩ:I
...
.method public platformViewOfNode(I)Landroid/view/View;
    ...
    :cond_0
    iget-object p1, p1, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;->Ϳ:Landroid/view/View;
...
.method public requestSendAccessibilityEvent(Landroid/view/View;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-static {v1, p3}, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->Ϳ(Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;Landroid/view/accessibility/AccessibilityRecord;)Ljava/lang/Long;
    ...
    new-instance v5, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;

    invoke-direct {v5, p1, v4}, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;-><init>(Landroid/view/View;I)V
    ...
    iget-object v4, p0, Lio/flutter/view/AccessibilityViewEmbedder;->reflectionAccessors:Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;

    invoke-static {v4, v3}, Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;->Ϳ(Lio/flutter/view/AccessibilityViewEmbedder$Ϳ;Landroid/view/accessibility/AccessibilityRecord;)Ljava/lang/Long;
    ...
    new-instance v4, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;

    invoke-direct {v4, p1, v5}, Lio/flutter/view/AccessibilityViewEmbedder$Ԩ;-><init>(Landroid/view/View;I)V
