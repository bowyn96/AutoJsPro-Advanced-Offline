...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/flutter/embedding/engine/FlutterJNI$Ԩ;,
        Lio/flutter/embedding/engine/FlutterJNI$Ϳ;,
        Lio/flutter/embedding/engine/FlutterJNI$Ԫ;
    }
.end annotation
...
.field private static asyncWaitForVsyncDelegate:Lio/flutter/embedding/engine/FlutterJNI$Ԩ; = null
...
# instance fields
.field private accessibilityDelegate:Lio/flutter/embedding/engine/FlutterJNI$Ϳ;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field private deferredComponentManager:Lokhttp3/internal/io/w6;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field private localizationPlugin:Lokhttp3/internal/io/x52;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.field private platformMessageHandler:Lokhttp3/internal/io/ed3;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field private platformViewsController:Lio/flutter/plugin/platform/Ԩ;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method private static asyncWaitForVsync(J)V
    ...
    sget-object v0, Lio/flutter/embedding/engine/FlutterJNI;->asyncWaitForVsyncDelegate:Lio/flutter/embedding/engine/FlutterJNI$Ԩ;

    if-eqz v0, :cond_0

    invoke-interface {v0, p0, p1}, Lio/flutter/embedding/engine/FlutterJNI$Ԩ;->Ϳ(J)V
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    :try_start_0
    new-instance v0, Lokhttp3/internal/io/ob0;

    invoke-direct {v0, p1, p2}, Lokhttp3/internal/io/ob0;-><init>(J)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lokhttp3/internal/io/ed3;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Lokhttp3/internal/io/ed3;->Ϳ(ILjava/nio/ByteBuffer;)V
...
.method private updateCustomAccessibilityActions(Ljava/nio/ByteBuffer;[Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->accessibilityDelegate:Lio/flutter/embedding/engine/FlutterJNI$Ϳ;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Lio/flutter/embedding/engine/FlutterJNI$Ϳ;->Ԩ(Ljava/nio/ByteBuffer;[Ljava/lang/String;)V
...
.method private updateSemantics(Ljava/nio/ByteBuffer;[Ljava/lang/String;[Ljava/nio/ByteBuffer;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lio/flutter/embedding/engine/FlutterJNI$Ϳ;->Ϳ(Ljava/nio/ByteBuffer;[Ljava/lang/String;[Ljava/nio/ByteBuffer;)V

    :cond_0
    return-void
.end method

.method public static synthetic Ϳ(JLandroid/graphics/ImageDecoder;Landroid/graphics/ImageDecoder$ImageInfo;Landroid/graphics/ImageDecoder$Source;)V
    .locals 0
...
# virtual methods
.method public addEngineLifecycleListener(Lio/flutter/embedding/engine/Ϳ$Ԩ;)V
    .locals 1
    .param p1    # Lio/flutter/embedding/engine/Ϳ$Ԩ;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/UiThread;
...
.method public addIsDisplayingFlutterUiListener(Lokhttp3/internal/io/cc0;)V
    .locals 1
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lokhttp3/internal/io/x52;
    ...
    :cond_4
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lokhttp3/internal/io/x52;

    invoke-virtual {p1, v0}, Lokhttp3/internal/io/x52;->Ԩ(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/Ԩ;
    ...
    sget-object v5, Lio/flutter/embedding/android/FlutterImageView$Ϳ;->ၦ:Lio/flutter/embedding/android/FlutterImageView$Ϳ;

    invoke-direct {v1, v2, v3, v4, v5}, Lio/flutter/embedding/android/FlutterImageView;-><init>(Landroid/content/Context;IILio/flutter/embedding/android/FlutterImageView$Ϳ;)V

    .line 2
    iget v2, v0, Lio/flutter/plugin/platform/Ԩ;->ރ:I

    add-int/lit8 v3, v2, 0x1

    iput v3, v0, Lio/flutter/plugin/platform/Ԩ;->ރ:I

    iget-object v0, v0, Lio/flutter/plugin/platform/Ԩ;->ށ:Landroid/util/SparseArray;
...
.method public dispatchSemanticsAction(ILio/flutter/view/Ϳ$Ԭ;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2, v0}, Lio/flutter/embedding/engine/FlutterJNI;->dispatchSemanticsAction(ILio/flutter/view/Ϳ$Ԭ;Ljava/lang/Object;)V

    return-void
.end method

.method public dispatchSemanticsAction(ILio/flutter/view/Ϳ$Ԭ;Ljava/lang/Object;)V
    .locals 1
    .param p2    # Lio/flutter/view/Ϳ$Ԭ;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v0, p3}, Lokhttp3/internal/io/uz4;->Ϳ(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/Ϳ$Ԭ;->ၥ:I
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Lokhttp3/internal/io/ed3;->Ԩ(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public onBeginFrame()V
    ...
    .line 1
    iget-object v1, v0, Lio/flutter/plugin/platform/Ԩ;->ކ:Ljava/util/HashSet;

    invoke-virtual {v1}, Ljava/util/HashSet;->clear()V

    iget-object v0, v0, Lio/flutter/plugin/platform/Ԩ;->އ:Ljava/util/HashSet;
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    .line 1
    iget-object v1, v0, Lio/flutter/plugin/platform/Ԩ;->ށ:Landroid/util/SparseArray;
    ...
    .line 2
    iget-boolean v1, v0, Lio/flutter/plugin/platform/Ԩ;->ޅ:Z

    if-eqz v1, :cond_0

    iget-boolean v1, v0, Lio/flutter/plugin/platform/Ԩ;->ބ:Z

    if-nez v1, :cond_0

    iget-object v1, v0, Lio/flutter/plugin/platform/Ԩ;->Ԫ:Lio/flutter/embedding/android/FlutterView;

    invoke-virtual {v1}, Lio/flutter/embedding/android/FlutterView;->convertToImageView()V
    ...
    iget-object p2, v0, Lio/flutter/plugin/platform/Ԩ;->ކ:Ljava/util/HashSet;
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    iget-object v2, v1, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/Ԩ;

    if-eqz v2, :cond_6

    .line 1
    iget-boolean v3, v2, Lio/flutter/plugin/platform/Ԩ;->ޅ:Z

    if-eqz v3, :cond_0

    iget-boolean v3, v2, Lio/flutter/plugin/platform/Ԩ;->ބ:Z

    if-nez v3, :cond_0

    iget-object v3, v2, Lio/flutter/plugin/platform/Ԩ;->Ԫ:Lio/flutter/embedding/android/FlutterView;

    invoke-virtual {v3}, Lio/flutter/embedding/android/FlutterView;->convertToImageView()V

    const/4 v3, 0x1

    iput-boolean v3, v2, Lio/flutter/plugin/platform/Ԩ;->ބ:Z

    .line 2
    :cond_0
    iget-object v3, v2, Lio/flutter/plugin/platform/Ԩ;->ؠ:Landroid/util/SparseArray;
    ...
    iget-object v4, v2, Lio/flutter/plugin/platform/Ԩ;->ހ:Landroid/util/SparseArray;
    ...
    iget-object v5, v2, Lio/flutter/plugin/platform/Ԩ;->ԩ:Landroid/content/Context;
    ...
    iget-object v7, v2, Lio/flutter/plugin/platform/Ԩ;->Ԩ:Lokhttp3/internal/io/ͳ;

    invoke-direct {v4, v5, v6, v7}, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;-><init>(Landroid/content/Context;FLokhttp3/internal/io/ͳ;)V

    new-instance v5, Lokhttp3/internal/io/ae3;

    invoke-direct {v5, v2, p1}, Lokhttp3/internal/io/ae3;-><init>(Lio/flutter/plugin/platform/Ԩ;I)V
    ...
    iget-object v5, v2, Lio/flutter/plugin/platform/Ԩ;->ހ:Landroid/util/SparseArray;
    ...
    .line 3
    :goto_0
    iget-object v3, v2, Lio/flutter/plugin/platform/Ԩ;->ހ:Landroid/util/SparseArray;
    ...
    invoke-virtual/range {v4 .. v9}, Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorView;->readyToDisplay(Lio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;IIII)V
    ...
    iget-object v4, v2, Lio/flutter/plugin/platform/Ԩ;->ؠ:Landroid/util/SparseArray;
    ...
    invoke-interface {v4}, Lokhttp3/internal/io/sd3;->getView()Landroid/view/View;
    ...
    :cond_2
    iget-object v2, v2, Lio/flutter/plugin/platform/Ԩ;->އ:Ljava/util/HashSet;
    ...
    const-string v2, "Platform view hasn\'t been initialized from the platform view channel."
...
.method public onEndFrame()V
    ...
    iget-object v1, v0, Lio/flutter/plugin/platform/Ԩ;->އ:Ljava/util/HashSet;
    ...
    iput-boolean v2, v0, Lio/flutter/plugin/platform/Ԩ;->ބ:Z

    iget-object v1, v0, Lio/flutter/plugin/platform/Ԩ;->Ԫ:Lio/flutter/embedding/android/FlutterView;

    new-instance v2, Lokhttp3/internal/io/ۦ;

    const/4 v3, 0x2

    invoke-direct {v2, v0, v3}, Lokhttp3/internal/io/ۦ;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v1, v2}, Lio/flutter/embedding/android/FlutterView;->revertImageView(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v1}, Lio/flutter/embedding/android/FlutterView;->acquireLatestImageViewFrame()Z
    ...
    :cond_1
    invoke-virtual {v0, v2}, Lio/flutter/plugin/platform/Ԩ;->ؠ(Z)V
...
.method public removeEngineLifecycleListener(Lio/flutter/embedding/engine/Ϳ$Ԩ;)V
    .locals 1
    .param p1    # Lio/flutter/embedding/engine/Ϳ$Ԩ;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public removeIsDisplayingFlutterUiListener(Lokhttp3/internal/io/cc0;)V
    .locals 1
    .param p1    # Lokhttp3/internal/io/cc0;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method public requestDartDeferredLibrary(I)V
    ...
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lokhttp3/internal/io/w6;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lokhttp3/internal/io/w6;->ԩ()V
...
.method public setAccessibilityDelegate(Lio/flutter/embedding/engine/FlutterJNI$Ϳ;)V
    .locals 0
    .param p1    # Lio/flutter/embedding/engine/FlutterJNI$Ϳ;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/UiThread;
    ...
    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->accessibilityDelegate:Lio/flutter/embedding/engine/FlutterJNI$Ϳ;
...
.method public setAsyncWaitForVsyncDelegate(Lio/flutter/embedding/engine/FlutterJNI$Ԩ;)V
    .locals 0
    .param p1    # Lio/flutter/embedding/engine/FlutterJNI$Ԩ;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param

    sput-object p1, Lio/flutter/embedding/engine/FlutterJNI;->asyncWaitForVsyncDelegate:Lio/flutter/embedding/engine/FlutterJNI$Ԩ;

    return-void
.end method

.method public setDeferredComponentManager(Lokhttp3/internal/io/w6;)V
    .locals 0
    .param p1    # Lokhttp3/internal/io/w6;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/UiThread;
    ...
    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lokhttp3/internal/io/w6;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lokhttp3/internal/io/w6;->Ϳ()V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Lokhttp3/internal/io/x52;)V
    .locals 0
    .param p1    # Lokhttp3/internal/io/x52;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/UiThread;
    ...
    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lokhttp3/internal/io/x52;

    return-void
.end method

.method public setPlatformMessageHandler(Lokhttp3/internal/io/ed3;)V
    .locals 0
    .param p1    # Lokhttp3/internal/io/ed3;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/UiThread;
    ...
    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lokhttp3/internal/io/ed3;

    return-void
.end method

.method public setPlatformViewsController(Lio/flutter/plugin/platform/Ԩ;)V
    .locals 0
    .param p1    # Lio/flutter/plugin/platform/Ԩ;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/UiThread;
    ...
    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/Ԩ;
