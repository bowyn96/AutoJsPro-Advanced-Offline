...
.method public static loadFromMemory(Lcom/stardust/autojs/runtime/api/Engines;[B)V
    .locals 5
    .param p0, "engines"    # Lcom/stardust/autojs/runtime/api/Engines;
    .param p1, "bytes"    # [B
    ...
    invoke-virtual {v0}, Lcom/stardust/autojs/engine/RhinoJavaScriptEngine;->getScriptable()Lorg/mozilla/javascript/Scriptable;

    move-result-object v0

    .line 54
    .local v0, "scope":Lorg/mozilla/javascript/Scriptable;
    iget-object v1, p0, Lcom/stardust/autojs/runtime/api/Engines;->mScriptEngine:Lcom/stardust/autojs/engine/RhinoJavaScriptEngine;

    invoke-virtual {v1}, Lcom/stardust/autojs/engine/RhinoJavaScriptEngine;->getContext()Lorg/mozilla/javascript/Context;
    ...
    new-instance v2, Lcom/stardust/autojs/core/IgnoreSerialID;

    invoke-direct {v2, v1, v0}, Lcom/stardust/autojs/core/IgnoreSerialID;-><init>(Ljava/io/InputStream;Lorg/mozilla/javascript/Scriptable;)V

    .line 58
    .local v2, "ignoreSerialID":Lcom/stardust/autojs/core/IgnoreSerialID;
    invoke-virtual {v2}, Lcom/stardust/autojs/core/IgnoreSerialID;->readObject()Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lorg/mozilla/javascript/Script;
    ...
    invoke-virtual {v4}, Lcom/stardust/autojs/engine/RhinoJavaScriptEngine;->getContext()Lorg/mozilla/javascript/Context;

    move-result-object v4

    invoke-interface {v3, v4, v0}, Lorg/mozilla/javascript/Script;->exec(Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;)Ljava/lang/Object;

    .line 60
    invoke-virtual {v2}, Lcom/stardust/autojs/core/IgnoreSerialID;->close()V
    ...
    .end local v2    # "ignoreSerialID":Lcom/stardust/autojs/core/IgnoreSerialID;
...
.method public execScriptFile(Landroid/app/Activity;Ljava/lang/String;Lcom/stardust/autojs/execution/ExecutionConfig;)Lcom/stardust/autojs/execution/ScriptExecution;
    ...
    .param p3, "executionConfig"    # Lcom/stardust/autojs/execution/ExecutionConfig;
    ...
    .line 36
    invoke-static {p1, p0, p2, p3}, Lcom/stardust/autojs/core/RemoteRun;->execScriptFile(Landroid/app/Activity;Lcom/stardust/autojs/runtime/api/Engines;Ljava/lang/String;Lcom/stardust/autojs/execution/ExecutionConfig;)Lcom/stardust/autojs/execution/ScriptExecution;
    ...
    invoke-virtual {p0}, Lcom/stardust/autojs/runtime/api/Engines;->myEngine()Lcom/stardust/autojs/engine/JavaScriptEngine;

    move-result-object v2

    invoke-virtual {v2}, Lcom/stardust/autojs/engine/JavaScriptEngine;->cwd()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/stardust/autojs/engine/JavaScriptEngine;->cwd()Ljava/lang/String;
    ...
    const-string v1, "Packages.com.stardust.autojs.core.RemoteRun.loadSnap(\""
    ...
    invoke-static {p2}, Lcom/stardust/autojs/core/RemoteRun;->hasui(Ljava/lang/String;)Z
    ...
    .line 48
    :cond_3
    const-string v1, "snapshot_script"

    invoke-virtual {p0, p1, v1, v0, p3}, Lcom/stardust/autojs/runtime/api/Engines;->execScript(Landroid/app/Activity;Ljava/lang/String;Ljava/lang/String;Lcom/stardust/autojs/execution/ExecutionConfig;)Lcom/stardust/autojs/execution/ScriptExecution;
    ...
    .line 50
    .end local v0    # "Runjs":Ljava/lang/String;
    :cond_4
    invoke-virtual {p0, p1, p2, p3}, Lcom/stardust/autojs/runtime/api/Engines;->execScriptFile0(Landroid/app/Activity;Ljava/lang/String;Lcom/stardust/autojs/execution/ExecutionConfig;)Lcom/stardust/autojs/execution/ScriptExecution;
...
.method public execScriptFile0(Landroid/app/Activity;Ljava/lang/String;Lcom/stardust/autojs/execution/ExecutionConfig;)Lcom/stardust/autojs/execution/ScriptExecution;
    .locals 3
