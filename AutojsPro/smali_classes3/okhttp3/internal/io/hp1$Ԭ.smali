.class public final Lokhttp3/internal/io/hp1$Ԭ;
...
# static fields
.field public static final ၶ:Lokhttp3/internal/io/hp1$Ԭ;

.field public static ၷ:Lokhttp3/internal/io/hp1$Ԭ$Ϳ;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lokhttp3/internal/io/hp1$Ԭ$Ϳ;

    invoke-direct {v0}, Lokhttp3/internal/io/hp1$Ԭ$Ϳ;-><init>()V

    sput-object v0, Lokhttp3/internal/io/hp1$Ԭ;->ၷ:Lokhttp3/internal/io/hp1$Ԭ$Ϳ;

    new-instance v0, Lokhttp3/internal/io/hp1$Ԭ;

    invoke-direct {v0}, Lokhttp3/internal/io/hp1$Ԭ;-><init>()V

    sput-object v0, Lokhttp3/internal/io/hp1$Ԭ;->ၶ:Lokhttp3/internal/io/hp1$Ԭ;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၯ:I

    iput-byte v0, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၰ:B

    iput v0, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၵ:I

    sget-object v0, Lokhttp3/internal/io/ખ;->ၥ:Lokhttp3/internal/io/p42;

    iput-object v0, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၥ:Lokhttp3/internal/io/ખ;
...
.method public constructor <init>(Lkotlin/reflect/jvm/internal/impl/protobuf/Ԫ;Lkotlin/reflect/jvm/internal/impl/protobuf/Ԭ;)V
    ...
    iput-object v0, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၦ:Ljava/util/List;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;
    ...
    invoke-virtual {p1, v6}, Lkotlin/reflect/jvm/internal/impl/protobuf/Ԫ;->Ԫ(I)I
    ...
    iput-object v7, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;
    ...
    iget-object v7, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;
    ...
    :cond_3
    invoke-virtual {p1, v6}, Lkotlin/reflect/jvm/internal/impl/protobuf/Ԫ;->ԩ(I)V
    ...
    iput-object v6, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;

    or-int/lit8 v4, v4, 0x2

    :cond_5
    iget-object v6, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;
    ...
    iput-object v6, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၦ:Ljava/util/List;

    or-int/lit8 v4, v4, 0x1

    :cond_7
    iget-object v6, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၦ:Ljava/util/List;

    sget-object v7, Lokhttp3/internal/io/hp1$Ԭ$Ԫ;->ၽ:Lokhttp3/internal/io/hp1$Ԭ$Ԫ$Ϳ;
    ...
    iget-object p2, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၦ:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၦ:Ljava/util/List;
    ...
    iget-object p2, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;
    ...
    iput-object p2, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၥ:Lokhttp3/internal/io/ખ;
    ...
    iget-object p1, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၦ:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၦ:Ljava/util/List;
    ...
    iget-object p1, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;
    ...
    iput-object p1, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၥ:Lokhttp3/internal/io/ખ;
...
.method public final getSerializedSize()I
    ...
    iget v0, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၵ:I
    ...
    :goto_0
    iget-object v3, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၦ:Ljava/util/List;
    ...
    :goto_1
    iget-object v3, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;
    ...
    :cond_3
    iput v1, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၯ:I

    iget-object v0, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၥ:Lokhttp3/internal/io/ખ;
...
.method public final isInitialized()Z
    ...
    iget-byte v0, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၰ:B
    ...
    :cond_1
    iput-byte v1, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၰ:B
...
.method public final toBuilder()Lkotlin/reflect/jvm/internal/impl/protobuf/ށ$Ϳ;
    ...
    .line 2
    invoke-virtual {v0, p0}, Lokhttp3/internal/io/hp1$Ԭ$Ԩ;->ԭ(Lokhttp3/internal/io/hp1$Ԭ;)Lokhttp3/internal/io/hp1$Ԭ$Ԩ;
...
.method public final Ϳ(Lokhttp3/internal/io/ঋ;)V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/io/hp1$Ԭ;->getSerializedSize()I
    ...
    :goto_0
    iget-object v2, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၦ:Ljava/util/List;
    ...
    .line 1
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၮ:Ljava/util/List;
    ...
    iget v1, p0, Lokhttp3/internal/io/hp1$Ԭ;->ၯ:I
