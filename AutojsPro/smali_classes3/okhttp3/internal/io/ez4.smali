...
.method public final ԯ(Lokhttp3/internal/io/ob1$Ϳ;)V
    ...
    const-string/jumbo v4, "{} processing the NEED_WRAP state"
    ...
    const-string/jumbo v2, "{} processing the NEED_UNWRAP state"
    ...
    const-string/jumbo v2, "{} processing the NEED_TASK state"
    ...
    const-string/jumbo v4, "{} processing the FINISHED state"
    ...
    const-string/jumbo v1, "{} is now secured"
    ...
    const-string/jumbo v1, "{} is not secured yet"
...
.method public final ހ(Lokhttp3/internal/io/ob1$Ϳ;Ljava/nio/ByteBuffer;)V
    ...
    const-string/jumbo v2, "{} Processing the received message"
