...
# static fields
.field public static final ԩ:[S

.field public static final Ԫ:[S
...
.method public static constructor <clinit>()V
    ...
    sput-object v1, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->ԩ:[S

    new-array v0, v0, [S

    fill-array-data v0, :array_1

    sput-object v0, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->Ԫ:[S
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->Ԩ:I
...
.method public final engineGetEncoded()[B
    ...
    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->Ϳ:[B
...
.method public final engineGetEncoded(Ljava/lang/String;)[B
    ...
    iget p1, p0, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->Ԩ:I

    const/4 v0, -0x1

    if-ne p1, v0, :cond_0

    new-instance p1, Lokhttp3/internal/io/mq3;

    invoke-virtual {p0}, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->engineGetEncoded()[B

    move-result-object v0

    invoke-direct {p1, v0}, Lokhttp3/internal/io/mq3;-><init>([B)V
    ...
    :cond_0
    new-instance v0, Lokhttp3/internal/io/mq3;

    invoke-virtual {p0}, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->engineGetEncoded()[B

    move-result-object v1

    invoke-direct {v0, p1, v1}, Lokhttp3/internal/io/mq3;-><init>(I[B)V
...
.method public final engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->Ϳ:[B
    ...
    sget-object v1, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->ԩ:[S
...
.method public final engineInit([BLjava/lang/String;)V
    ...
    .line 1
    instance-of p2, p1, Lokhttp3/internal/io/mq3;

    const/4 v0, 0x0

    if-eqz p2, :cond_0

    check-cast p1, Lokhttp3/internal/io/mq3;
    ...
    new-instance p2, Lokhttp3/internal/io/mq3;

    invoke-static {p1}, Lokhttp3/internal/io/ޥ;->ބ(Ljava/lang/Object;)Lokhttp3/internal/io/ޥ;

    move-result-object p1

    invoke-direct {p2, p1}, Lokhttp3/internal/io/mq3;-><init>(Lokhttp3/internal/io/ޥ;)V
    ...
    .line 2
    :goto_0
    iget-object p2, p1, Lokhttp3/internal/io/mq3;->ၥ:Lokhttp3/internal/io/ޜ;
    ...
    :cond_2
    invoke-virtual {p2}, Lokhttp3/internal/io/ޜ;->އ()Ljava/math/BigInteger;
    ...
    iput p2, p0, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->Ԩ:I

    .line 5
    :cond_4
    iget-object p1, p1, Lokhttp3/internal/io/mq3;->ၦ:Lokhttp3/internal/io/ޠ;
...
.method public final Ԩ(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    :cond_0
    iget v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->Ԩ:I
    ...
    sget-object v0, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->Ԫ:[S

    iget v1, p0, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->Ԩ:I

    aget-short v0, v0, v1

    iget-object v1, p0, Lorg/spongycastle/jcajce/provider/symmetric/RC2$AlgParams;->Ϳ:[B
