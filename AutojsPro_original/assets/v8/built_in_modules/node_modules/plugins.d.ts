 ...
 * ```
 */
export declare function load(packageName: string): Promise<any>;
/**
 * @中文
 *
 ...
 */
export declare function unload(packageName: string): Promise<boolean>;
/**
 * @中文
 *
 ...
 */
export declare function unloadAll(): Promise<void>;
