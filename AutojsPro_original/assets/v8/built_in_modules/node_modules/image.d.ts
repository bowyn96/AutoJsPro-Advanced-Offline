...
export declare enum FeatureDetectMethod {
    SIFT = 1,
    ORB = 2
}
export declare enum FeatureMatcher {
    FLANNBASED = 1,
    BRUTEFORCE = 2,
    BRUTEFORCE_L1 = 3,
...
export declare abstract class ImageFeatures {
    abstract recycle(): void;
}
export declare class ImageFeaturesImpl {
...
export declare function matchFeatures(scene: ImageFeatures, object: ImageFeatures, options?: FeatureMatchingOptions): Promise<ObjectFrame | null>;
export declare function matchTemplate(src: Image, template: Image, options: MatchTemplateOptions): Promise<Array<Match>>;
export declare function matchTemplateSync(src: Image, template: Image, options: MatchTemplateOptions): Array<Match>;
