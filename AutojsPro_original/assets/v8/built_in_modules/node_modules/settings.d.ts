 ...
 */
export declare const stableMode: SettingItem<boolean>;
/**
 * @中文
 *
 ...
 */
export declare const enableAccessibilityServiceByRoot: SettingItem<boolean>;
/**
 * @中文
 *
 ...
 */
export declare const stopAllOnVolumeUp: SettingItem<boolean>;
/**
 * @中文
 *
 ...
 */
export declare const noConsoleOnLaunch: SettingItem<boolean>;
/**
 * @中文
 *
 * 前台服务。用于保活、截图权限。
 ...
 */
export declare const foregroundService: SettingItem<boolean>;
