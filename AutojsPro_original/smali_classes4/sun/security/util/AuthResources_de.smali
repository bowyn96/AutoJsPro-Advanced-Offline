...
.method public static constructor <clinit>()V
    ...
    const-string v3, "Ung\u00fcltige Nulleingabe: {0}"
    ...
    const-string v3, "NT-Dom\u00e4nen-Principal: {0}"
    ...
    const-string v3, "NT numerische Authentisierung: {0}"
    ...
    const-string v3, "Ung\u00fcltiger NTSid-Wert"
    ...
    const-string v3, "NT-Sid-Dom\u00e4nen-Principal: {0}"
    ...
    const-string v3, "NT-Sid-Gruppen-Principal: {0}"
    ...
    const-string v3, "NT-Sid-Prim\u00e4rgruppen-Principal: {0}"
    ...
    const-string v3, "NT-Sid-Benutzer-Principal: {0}"
    ...
    const-string v3, "NT-Benutzer-Principal: {0}"
    ...
    const-string v3, "Unix numerischer Gruppen-Principal [Prim\u00e4rgruppe]: {0}"
    ...
    const-string v3, "Unix numerische Gruppen-Principal [Zusatzgruppe]: {0}"
    ...
    const-string v3, "Unix numerischer Benutzer-Principal: {0}"
    ...
    const-string v3, "Unix-Principal: {0}"
    ...
    const-string v3, "{0} kann nicht ordnungsgem\u00e4\u00df erweitert werden."
    ...
    const-string v3, "{0} (Datei oder Verzeichnis existiert nicht.)"
    ...
    const-string v3, "Anmeldekonfiguration kann nicht gefunden werden."
    ...
    const-string v3, "Konfigurationsfehler:\n\tUng\u00fcltiges Steuerflag, {0}"
    ...
    const-string v3, "Bitte geben Sie die Keystore-Informationen ein"
    ...
    const-string v3, "Keystore-Passwort: "
    ...
    const-string v3, "Privates Schl\u00fcsselpasswort (optional): "
    ...
    const-string v3, "Kerberos-Benutzername [{0}]: "
    ...
    const-string v3, "Kerberos-Passwort f\u00fcr {0}: "
    ...
    const-string v3, ": Fehler beim Hinzuf\u00fcgen der Berechtigung "
    ...
    const-string v3, ": Fehler beim Hinzuf\u00fcgen des Eintrags "
    ...
    const-string v3, "Es wurde versucht, eine Berechtigung zu einer schreibgesch\u00fctzten Berechtigungssammlung hinzuzuf\u00fcgen."
    ...
    const-string v3, "Principal kann nicht mit einer "
    ...
    const-string v3, "Wildcard-Klasse ohne Wildcard-Namen angegeben werden."
    ...
    const-string v3, "codeBase oder SignedBy erwartet"
    ...
    const-string v3, "Nur Principal-basierte Berechtigungseintr\u00e4ge erlaubt"
    ...
    const-string v3, ", Dateiende lesen"
    ...
    const-string v3, "\';\' erwartet, Dateiende lesen"
    ...
    const-string v3, "Solaris numerischer Gruppen-Principal [Prim\u00e4rgruppe]: "
    ...
    const-string v3, "Solaris numerischer Gruppen-Principal [Zusatzgruppe]: "
    ...
    const-string v3, "Solaris numerischer Benutzer-Principal: "
    ...
    const-string v3, "Solaris-Principal: "
