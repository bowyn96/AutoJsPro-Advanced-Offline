...
.field public ၦ:Lokhttp3/internal/io/xl0;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->ၥ:Lokhttp3/internal/io/zl0;

    new-instance v0, Lokhttp3/internal/io/xl0;

    invoke-direct {v0}, Lokhttp3/internal/io/xl0;-><init>()V

    iput-object v0, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->ၦ:Lokhttp3/internal/io/xl0;
...
.method public final engineInitSign(Ljava/security/PrivateKey;)V
    ...
    :goto_0
    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->ၥ:Lokhttp3/internal/io/zl0;

    invoke-virtual {v0}, Lokhttp3/internal/io/zl0;->ԩ()V

    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->ၮ:Ljava/security/SecureRandom;

    const/4 v1, 0x1

    if-eqz v0, :cond_1

    iget-object v2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->ၦ:Lokhttp3/internal/io/xl0;
    ...
    invoke-virtual {v2, v1, v3}, Lokhttp3/internal/io/xl0;->Ϳ(ZLokhttp3/internal/io/ɣ;)V

    goto :goto_1

    :cond_1
    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->ၦ:Lokhttp3/internal/io/xl0;

    invoke-virtual {v0, v1, p1}, Lokhttp3/internal/io/xl0;->Ϳ(ZLokhttp3/internal/io/ɣ;)V
...
.method public final engineInitSign(Ljava/security/PrivateKey;Ljava/security/SecureRandom;)V
    ...
    iput-object p2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->ၮ:Ljava/security/SecureRandom;
...
.method public final engineInitVerify(Ljava/security/PublicKey;)V
    ...
    instance-of v1, p1, Lokhttp3/internal/io/sn;
    ...
    :cond_0
    instance-of v1, p1, Lokhttp3/internal/io/gl0;
...
.method public final engineSign()[B
    ...
    iget-object v2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->ၥ:Lokhttp3/internal/io/zl0;
    ...
    iget-object v5, p0, Lorg/spongycastle/jcajce/provider/asymmetric/gost/SignatureSpi;->ၦ:Lokhttp3/internal/io/xl0;

    invoke-virtual {v5, v1}, Lokhttp3/internal/io/xl0;->Ԩ([B)[Ljava/math/BigInteger;
...
.method public final engineVerify([B)Z
    ...
    invoke-virtual {v0, v1, v2, p1}, Lokhttp3/internal/io/xl0;->ԩ([BLjava/math/BigInteger;Ljava/math/BigInteger;)Z
