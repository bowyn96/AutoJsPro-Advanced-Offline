...
# static fields
.field public static final ၰ:Lokhttp3/internal/io/pm3;

.field public static ၵ:Lokhttp3/internal/io/pm3$Ϳ;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lokhttp3/internal/io/pm3$Ϳ;

    invoke-direct {v0}, Lokhttp3/internal/io/pm3$Ϳ;-><init>()V

    sput-object v0, Lokhttp3/internal/io/pm3;->ၵ:Lokhttp3/internal/io/pm3$Ϳ;

    new-instance v0, Lokhttp3/internal/io/pm3;

    invoke-direct {v0}, Lokhttp3/internal/io/pm3;-><init>()V

    sput-object v0, Lokhttp3/internal/io/pm3;->ၰ:Lokhttp3/internal/io/pm3;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lokhttp3/internal/io/pm3;->ၮ:B

    iput v0, p0, Lokhttp3/internal/io/pm3;->ၯ:I

    sget-object v0, Lokhttp3/internal/io/ખ;->ၥ:Lokhttp3/internal/io/p42;

    iput-object v0, p0, Lokhttp3/internal/io/pm3;->ၥ:Lokhttp3/internal/io/ખ;
...
.method public constructor <init>(Lkotlin/reflect/jvm/internal/impl/protobuf/Ԫ;Lkotlin/reflect/jvm/internal/impl/protobuf/Ԭ;)V
    ...
    iput-object v0, p0, Lokhttp3/internal/io/pm3;->ၦ:Ljava/util/List;
    ...
    iput-object v5, p0, Lokhttp3/internal/io/pm3;->ၦ:Ljava/util/List;

    or-int/lit8 v4, v4, 0x1

    :cond_2
    iget-object v5, p0, Lokhttp3/internal/io/pm3;->ၦ:Ljava/util/List;

    sget-object v6, Lokhttp3/internal/io/pm3$Ԫ;->ၸ:Lokhttp3/internal/io/pm3$Ԫ$Ϳ;
    ...
    iget-object p2, p0, Lokhttp3/internal/io/pm3;->ၦ:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lokhttp3/internal/io/pm3;->ၦ:Ljava/util/List;
    ...
    iput-object p2, p0, Lokhttp3/internal/io/pm3;->ၥ:Lokhttp3/internal/io/ખ;
    ...
    iget-object p1, p0, Lokhttp3/internal/io/pm3;->ၦ:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/io/pm3;->ၦ:Ljava/util/List;
    ...
    iput-object p1, p0, Lokhttp3/internal/io/pm3;->ၥ:Lokhttp3/internal/io/ખ;
...
.method public final getSerializedSize()I
    ...
    iget v0, p0, Lokhttp3/internal/io/pm3;->ၯ:I
    ...
    :goto_0
    iget-object v2, p0, Lokhttp3/internal/io/pm3;->ၦ:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lokhttp3/internal/io/pm3;->ၥ:Lokhttp3/internal/io/ખ;
...
.method public final isInitialized()Z
    ...
    iget-byte v0, p0, Lokhttp3/internal/io/pm3;->ၮ:B
    ...
    .line 1
    :goto_0
    iget-object v3, p0, Lokhttp3/internal/io/pm3;->ၦ:Ljava/util/List;
    ...
    check-cast v3, Lokhttp3/internal/io/pm3$Ԫ;

    .line 3
    invoke-virtual {v3}, Lokhttp3/internal/io/pm3$Ԫ;->isInitialized()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, Lokhttp3/internal/io/pm3;->ၮ:B
    ...
    :cond_3
    iput-byte v1, p0, Lokhttp3/internal/io/pm3;->ၮ:B
...
.method public final toBuilder()Lkotlin/reflect/jvm/internal/impl/protobuf/ށ$Ϳ;
    ...
    .line 2
    invoke-virtual {v0, p0}, Lokhttp3/internal/io/pm3$Ԩ;->ԭ(Lokhttp3/internal/io/pm3;)Lokhttp3/internal/io/pm3$Ԩ;
...
.method public final Ϳ(Lokhttp3/internal/io/ঋ;)V
    ...
    :goto_0
    iget-object v1, p0, Lokhttp3/internal/io/pm3;->ၦ:Ljava/util/List;
