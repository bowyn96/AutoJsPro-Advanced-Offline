.class public final Lokhttp3/internal/io/df4;
...
.method public final Ϳ(Lokhttp3/internal/io/ln;)Lokhttp3/internal/io/ln;
    ...
    invoke-virtual/range {p0 .. p0}, Lokhttp3/internal/io/df4;->ގ()Lokhttp3/internal/io/ln;
    ...
    new-instance v8, Lokhttp3/internal/io/df4;
    ...
    invoke-direct/range {v2 .. v7}, Lokhttp3/internal/io/df4;-><init>(Lokhttp3/internal/io/km;Lokhttp3/internal/io/sm;Lokhttp3/internal/io/sm;[Lokhttp3/internal/io/sm;Z)V
...
.method public final ԩ()Lokhttp3/internal/io/ln;
    ...
    new-instance v0, Lokhttp3/internal/io/df4;
    ...
    invoke-direct {v0, v3, v1, v2, v4}, Lokhttp3/internal/io/df4;-><init>(Lokhttp3/internal/io/km;Lokhttp3/internal/io/sm;Lokhttp3/internal/io/sm;Z)V
...
.method public final ޅ()Lokhttp3/internal/io/ln;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/io/df4;-><init>(Lokhttp3/internal/io/km;Lokhttp3/internal/io/sm;Lokhttp3/internal/io/sm;[Lokhttp3/internal/io/sm;Z)V
...
.method public final ތ()Lokhttp3/internal/io/ln;
    ...
    :cond_0
    invoke-virtual {p0}, Lokhttp3/internal/io/df4;->ގ()Lokhttp3/internal/io/ln;
...
.method public final ގ()Lokhttp3/internal/io/ln;
    ...
    iget-object v7, v0, Lokhttp3/internal/io/if4;->ԭ:[I

    invoke-static {v7, v6}, Lokhttp3/internal/io/ଜ;->֏([I[I)V

    new-array v7, v5, [I

    invoke-static {v6, v7}, Lokhttp3/internal/io/ଜ;->֏([I[I)V

    new-array v8, v5, [I

    iget-object v9, v1, Lokhttp3/internal/io/if4;->ԭ:[I

    invoke-static {v9, v8}, Lokhttp3/internal/io/ଜ;->֏([I[I)V

    invoke-static {v8, v8, v8}, Lokhttp3/internal/io/ʽ;->ԩ([I[I[I)I

    move-result v9

    invoke-static {v9, v8}, Lokhttp3/internal/io/ଜ;->ԯ(I[I)V

    iget-object v1, v1, Lokhttp3/internal/io/if4;->ԭ:[I

    invoke-static {v6, v1, v6}, Lokhttp3/internal/io/ଜ;->Ԫ([I[I[I)V
    ...
    invoke-static {v5, v1}, Lokhttp3/internal/io/ଜ;->ԯ(I[I)V

    new-instance v5, Lokhttp3/internal/io/if4;

    invoke-direct {v5, v7}, Lokhttp3/internal/io/if4;-><init>([I)V

    invoke-static {v8, v7}, Lokhttp3/internal/io/ଜ;->֏([I[I)V

    iget-object v7, v5, Lokhttp3/internal/io/if4;->ԭ:[I

    invoke-static {v7, v6, v7}, Lokhttp3/internal/io/ଜ;->ހ([I[I[I)V

    iget-object v7, v5, Lokhttp3/internal/io/if4;->ԭ:[I

    invoke-static {v7, v6, v7}, Lokhttp3/internal/io/ଜ;->ހ([I[I[I)V

    new-instance v7, Lokhttp3/internal/io/if4;

    invoke-direct {v7, v6}, Lokhttp3/internal/io/if4;-><init>([I)V

    iget-object v9, v5, Lokhttp3/internal/io/if4;->ԭ:[I

    invoke-static {v6, v9, v6}, Lokhttp3/internal/io/ଜ;->ހ([I[I[I)V

    iget-object v6, v7, Lokhttp3/internal/io/if4;->ԭ:[I

    invoke-static {v6, v8, v6}, Lokhttp3/internal/io/ଜ;->Ԫ([I[I[I)V

    iget-object v6, v7, Lokhttp3/internal/io/if4;->ԭ:[I

    invoke-static {v6, v1, v6}, Lokhttp3/internal/io/ଜ;->ހ([I[I[I)V

    new-instance v1, Lokhttp3/internal/io/if4;

    invoke-direct {v1, v8}, Lokhttp3/internal/io/if4;-><init>([I)V

    iget-object v0, v0, Lokhttp3/internal/io/if4;->ԭ:[I

    invoke-static {v0, v8}, Lokhttp3/internal/io/ଜ;->ށ([I[I)V
...
.method public final ޏ(Lokhttp3/internal/io/ln;)Lokhttp3/internal/io/ln;
    ...
    invoke-virtual {p0}, Lokhttp3/internal/io/df4;->ތ()Lokhttp3/internal/io/ln;
