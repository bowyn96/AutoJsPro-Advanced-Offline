...
.field private job:Lokhttp3/internal/io/yh1;
...
.method public final registerLayoutStateChangeCallback(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lokhttp3/internal/io/yh1;
    ...
    .line 3
    instance-of v2, v0, Lokhttp3/internal/io/gh;

    if-eqz v2, :cond_1

    move-object v2, v0

    check-cast v2, Lokhttp3/internal/io/gh;

    :cond_1
    new-instance v2, Lokhttp3/internal/io/zw;

    invoke-direct {v2, v0}, Lokhttp3/internal/io/zw;-><init>(Ljava/util/concurrent/Executor;)V
    ...
    invoke-direct {v2, p0, p1, v1}, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver$registerLayoutStateChangeCallback$1;-><init>(Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;Landroid/app/Activity;Lokhttp3/internal/io/ৡ;)V
    ...
    iput-object p1, p0, Landroidx/slidingpanelayout/widget/FoldingFeatureObserver;->job:Lokhttp3/internal/io/yh1;
...
.method public final unregisterLayoutStateChangeCallback()V
    ...
    invoke-static {v0, v2, v1, v2}, Lokhttp3/internal/io/yh1$Ϳ;->Ϳ(Lokhttp3/internal/io/yh1;Ljava/util/concurrent/CancellationException;ILjava/lang/Object;)V
