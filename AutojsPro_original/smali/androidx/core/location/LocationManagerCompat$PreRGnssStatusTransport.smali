...
.method public static synthetic Ϳ(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
    .locals 0
...
.method public static synthetic Ԩ(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;Landroid/location/GnssStatus;)V
    .locals 0
...
.method public static synthetic ԩ(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;I)V
    .locals 0
...
.method public static synthetic Ԫ(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
    .locals 0
...
.method public onFirstFix(I)V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/މ;

    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/މ;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;I)V
...
.method public onSatelliteStatusChanged(Landroid/location/GnssStatus;)V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/ފ;

    invoke-direct {v1, p0, v0, p1}, Landroidx/core/location/ފ;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;Landroid/location/GnssStatus;)V
...
.method public onStarted()V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/ވ;

    invoke-direct {v1, p0, v0}, Landroidx/core/location/ވ;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
...
.method public onStopped()V
    ...
    :cond_0
    new-instance v1, Landroidx/core/location/އ;

    invoke-direct {v1, p0, v0}, Landroidx/core/location/އ;-><init>(Landroidx/core/location/LocationManagerCompat$PreRGnssStatusTransport;Ljava/util/concurrent/Executor;)V
