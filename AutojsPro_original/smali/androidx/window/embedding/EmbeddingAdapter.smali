...
.method public static synthetic Ϳ(Ljava/util/Set;Landroid/app/Activity;)Z
    .locals 0
...
.method public static synthetic Ԩ(Landroidx/window/embedding/SplitRule;Landroid/view/WindowMetrics;)Z
    .locals 0
...
.method public static synthetic ԩ(Landroidx/window/embedding/EmbeddingAdapter;Ljava/util/Set;Landroid/util/Pair;)Z
    .locals 0
...
.method public static synthetic Ԫ(Landroidx/window/embedding/EmbeddingAdapter;Ljava/util/Set;Landroid/util/Pair;)Z
    .locals 0
...
.method public static synthetic ԫ(Ljava/util/Set;Landroid/content/Intent;)Z
    .locals 0
...
.method public final translateActivityIntentPredicates(Ljava/util/Set;)Lj$/util/function/Predicate;
    ...
    new-instance v0, Lokhttp3/internal/io/hq;

    invoke-direct {v0, p0, p1}, Lokhttp3/internal/io/hq;-><init>(Landroidx/window/embedding/EmbeddingAdapter;Ljava/util/Set;)V
...
.method public final translateActivityPairPredicates(Ljava/util/Set;)Lj$/util/function/Predicate;
    ...
    new-instance v0, Lokhttp3/internal/io/iq;

    invoke-direct {v0, p0, p1}, Lokhttp3/internal/io/iq;-><init>(Landroidx/window/embedding/EmbeddingAdapter;Ljava/util/Set;)V
...
.method public final translateActivityPredicates(Ljava/util/Set;)Lj$/util/function/Predicate;
    ...
    new-instance v0, Lokhttp3/internal/io/kq;

    invoke-direct {v0, p1}, Lokhttp3/internal/io/kq;-><init>(Ljava/util/Set;)V
...
.method public final translateIntentPredicates(Ljava/util/Set;)Lj$/util/function/Predicate;
    ...
    new-instance v0, Lokhttp3/internal/io/lq;

    invoke-direct {v0, p1}, Lokhttp3/internal/io/lq;-><init>(Ljava/util/Set;)V
...
.method public final translateParentMetricsPredicate(Landroidx/window/embedding/SplitRule;)Lj$/util/function/Predicate;
    ...
    new-instance v0, Lokhttp3/internal/io/jq;

    invoke-direct {v0, p1}, Lokhttp3/internal/io/jq;-><init>(Landroidx/window/embedding/SplitRule;)V
