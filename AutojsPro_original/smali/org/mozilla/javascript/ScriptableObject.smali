...
.method public addLazilyInitializedValue(Ljava/lang/String;ILorg/mozilla/javascript/LazilyLoadedCtor;I)V
    ...
    invoke-virtual {v0, p1, p2, v1}, Lorg/mozilla/javascript/SlotMapContainer;->modify(Ljava/lang/Object;II)Lorg/mozilla/javascript/Slot;

    move-result-object p1

    instance-of p2, p1, Lorg/mozilla/javascript/LazyLoadSlot;
    ...
    invoke-direct {p2, p1}, Lorg/mozilla/javascript/LazyLoadSlot;-><init>(Lorg/mozilla/javascript/Slot;)V

    iget-object v0, p0, Lorg/mozilla/javascript/ScriptableObject;->slotMap:Lorg/mozilla/javascript/SlotMapContainer;

    invoke-virtual {v0, p1, p2}, Lorg/mozilla/javascript/SlotMapContainer;->replace(Lorg/mozilla/javascript/Slot;Lorg/mozilla/javascript/Slot;)V
...
.method public checkPropertyChange(Ljava/lang/Object;Lorg/mozilla/javascript/ScriptableObject;Lorg/mozilla/javascript/ScriptableObject;)V
    ...
    invoke-virtual {p0, v3, v1}, Lorg/mozilla/javascript/ScriptableObject;->sameValue(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    const-string p1, "msg.change.property.accessor.to.data.with.configurable.false"
...
.method public defineOwnProperty(Lorg/mozilla/javascript/Context;Ljava/lang/Object;Lorg/mozilla/javascript/ScriptableObject;Z)V
    ...
    iget-object v3, v0, Lorg/mozilla/javascript/ScriptRuntime$StringIdOrIndex;->stringId:Ljava/lang/String;
    ...
    invoke-virtual {v4, v3, v0}, Lorg/mozilla/javascript/SlotMapContainer;->query(Ljava/lang/Object;I)Lorg/mozilla/javascript/Slot;
    ...
    :cond_3
    invoke-virtual {v4, p1, p0}, Lorg/mozilla/javascript/Slot;->getPropertyDescriptor(Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;)Lorg/mozilla/javascript/ScriptableObject;

    move-result-object v1

    :goto_2
    invoke-virtual {p0, p2, v1, p3}, Lorg/mozilla/javascript/ScriptableObject;->checkPropertyChange(Ljava/lang/Object;Lorg/mozilla/javascript/ScriptableObject;Lorg/mozilla/javascript/ScriptableObject;)V
    ...
    invoke-virtual {p2, v3, v0, v2}, Lorg/mozilla/javascript/SlotMapContainer;->modify(Ljava/lang/Object;II)Lorg/mozilla/javascript/Slot;
    ...
    :goto_3
    invoke-virtual {p0, p2, p3}, Lorg/mozilla/javascript/ScriptableObject;->applyDescriptorToAttributeBitset(ILorg/mozilla/javascript/ScriptableObject;)I

    move-result p2

    if-eqz p1, :cond_9

    instance-of p1, v4, Lorg/mozilla/javascript/AccessorSlot;

    if-eqz p1, :cond_6

    check-cast v4, Lorg/mozilla/javascript/AccessorSlot;

    goto :goto_4

    :cond_6
    new-instance p1, Lorg/mozilla/javascript/AccessorSlot;

    invoke-direct {p1, v4}, Lorg/mozilla/javascript/AccessorSlot;-><init>(Lorg/mozilla/javascript/Slot;)V

    iget-object p4, p0, Lorg/mozilla/javascript/ScriptableObject;->slotMap:Lorg/mozilla/javascript/SlotMapContainer;

    invoke-virtual {p4, v4, p1}, Lorg/mozilla/javascript/SlotMapContainer;->replace(Lorg/mozilla/javascript/Slot;Lorg/mozilla/javascript/Slot;)V
    ...
    new-instance v0, Lorg/mozilla/javascript/AccessorSlot$FunctionGetter;

    invoke-direct {v0, p1}, Lorg/mozilla/javascript/AccessorSlot$FunctionGetter;-><init>(Ljava/lang/Object;)V

    iput-object v0, v4, Lorg/mozilla/javascript/AccessorSlot;->getter:Lorg/mozilla/javascript/AccessorSlot$Getter;
    ...
    invoke-direct {p3, p1}, Lorg/mozilla/javascript/AccessorSlot$FunctionSetter;-><init>(Ljava/lang/Object;)V

    iput-object p3, v4, Lorg/mozilla/javascript/AccessorSlot;->setter:Lorg/mozilla/javascript/AccessorSlot$Setter;

    :cond_8
    sget-object p1, Lorg/mozilla/javascript/Undefined;->instance:Ljava/lang/Object;

    :goto_5
    iput-object p1, v4, Lorg/mozilla/javascript/Slot;->value:Ljava/lang/Object;

    goto :goto_7

    :cond_9
    invoke-virtual {v4}, Lorg/mozilla/javascript/Slot;->isValueSlot()Z
    ...
    invoke-direct {p1, v4}, Lorg/mozilla/javascript/Slot;-><init>(Lorg/mozilla/javascript/Slot;)V
    ...
    :cond_c
    :goto_7
    invoke-virtual {v4, p2}, Lorg/mozilla/javascript/Slot;->setAttributes(I)V

    return-void
.end method

.method public defineProperty(Ljava/lang/String;Lj$/util/function/Supplier;Lj$/util/function/Consumer;I)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1, v1, p4}, Lorg/mozilla/javascript/SlotMapContainer;->modify(Ljava/lang/Object;II)Lorg/mozilla/javascript/Slot;

    move-result-object v0

    instance-of v1, v0, Lorg/mozilla/javascript/LambdaSlot;

    if-eqz v1, :cond_0

    check-cast v0, Lorg/mozilla/javascript/LambdaSlot;

    goto :goto_0

    :cond_0
    new-instance v1, Lorg/mozilla/javascript/LambdaSlot;

    invoke-direct {v1, v0}, Lorg/mozilla/javascript/LambdaSlot;-><init>(Lorg/mozilla/javascript/Slot;)V

    iget-object v2, p0, Lorg/mozilla/javascript/ScriptableObject;->slotMap:Lorg/mozilla/javascript/SlotMapContainer;

    invoke-virtual {v2, v0, v1}, Lorg/mozilla/javascript/SlotMapContainer;->replace(Lorg/mozilla/javascript/Slot;Lorg/mozilla/javascript/Slot;)V

    move-object v0, v1

    :goto_0
    iput-object p2, v0, Lorg/mozilla/javascript/LambdaSlot;->getter:Lj$/util/function/Supplier;

    iput-object p3, v0, Lorg/mozilla/javascript/LambdaSlot;->setter:Lj$/util/function/Consumer;

    invoke-virtual {p0, p1, p4}, Lorg/mozilla/javascript/ScriptableObject;->setAttributes(Ljava/lang/String;I)V
...
.method public defineProperty(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;I)V
    ...
    invoke-static {v7, p1}, Lorg/mozilla/javascript/Context;->reportRuntimeErrorById(Ljava/lang/String;[Ljava/lang/Object;)Lorg/mozilla/javascript/EvaluatorException;
    ...
    invoke-virtual {p2, p1, v2, v2}, Lorg/mozilla/javascript/SlotMapContainer;->modify(Ljava/lang/Object;II)Lorg/mozilla/javascript/Slot;
    ...
    invoke-virtual {p3, p1, p2}, Lorg/mozilla/javascript/SlotMapContainer;->replace(Lorg/mozilla/javascript/Slot;Lorg/mozilla/javascript/Slot;)V
    ...
    invoke-direct {p2, v3}, Lorg/mozilla/javascript/AccessorSlot$MemberBoxGetter;-><init>(Lorg/mozilla/javascript/MemberBox;)V
    ...
    invoke-direct {p2, v0}, Lorg/mozilla/javascript/AccessorSlot$MemberBoxSetter;-><init>(Lorg/mozilla/javascript/MemberBox;)V
...
.method public getOwnPropertyDescriptor(Lorg/mozilla/javascript/Context;Ljava/lang/Object;)Lorg/mozilla/javascript/ScriptableObject;
    ...
    :cond_1
    invoke-virtual {p2, p1, v0}, Lorg/mozilla/javascript/Slot;->getPropertyDescriptor(Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;)Lorg/mozilla/javascript/ScriptableObject;
...
.method public querySlot(Lorg/mozilla/javascript/Context;Ljava/lang/Object;)Lorg/mozilla/javascript/Slot;
    ...
    invoke-virtual {p1, p2, v1}, Lorg/mozilla/javascript/SlotMapContainer;->query(Ljava/lang/Object;I)Lorg/mozilla/javascript/Slot;
...
.method public setGetterOrSetter(Ljava/lang/String;ILorg/mozilla/javascript/Callable;Z)V
    ...
    invoke-direct {v0, p2}, Lorg/mozilla/javascript/AccessorSlot;-><init>(Lorg/mozilla/javascript/Slot;)V

    iget-object v2, p0, Lorg/mozilla/javascript/ScriptableObject;->slotMap:Lorg/mozilla/javascript/SlotMapContainer;

    invoke-virtual {v2, p2, v0}, Lorg/mozilla/javascript/SlotMapContainer;->replace(Lorg/mozilla/javascript/Slot;Lorg/mozilla/javascript/Slot;)V
